...
class NodeFeatureEmbeddingLayer(nn.Module):
    def __init__(self, dataset_name, hidden_dim, numerical_feature_size=5, categorical_feature_size=3, des_feature_size=768,
    ...
    def forward(self, des_tensor, tweet_tensor, num_prop, category_prop):
        ...
        if self.dataset_name == 'Cresci-2015':
            category_prop = category_prop.expand(-1, 3)
